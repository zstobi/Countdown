...
KILL_INTERRUPTION_TYPE = "\033[91m#KILL\033[0m"
IO_IN_INTERRUPTION_TYPE = "\033[94m#IO_IN\033[0m"
IO_OUT_INTERRUPTION_TYPE = "\033[32m#IO_OUT\033[0m"
NEW_INTERRUPTION_TYPE = "\033[92m#NEW\033[0m"
TIMEOUT_INTERRUPTION_TYPE = "\033[95m#TIMEOUT\033[0m"
STAT_INTERRUPTION_TYPE = "\033[90m#STAT\033[0m"
...
class Cpu():
    ...
    def _execute(self):
        if ASM.isEXIT(self._ir):
            ...
            log.logger.info("\033[93mcpu - Exec: {instr}, PC={pc}, MMU={mmu}\033[0m".format(instr=self._ir,
                                                                             pc=self._pc,
    ...
    def tick(self, tickNbr):
        if (self._busy):
            ...
            if (self._ticksCount > self._deviceTime):
                ...
                log.logger.info("\033[94mdevice {deviceId} - Busy: {ticksCount} of {deviceTime}\033[0m".format(deviceId = self.deviceId, ticksCount = self._ticksCount, deviceTime = self._deviceTime))
